...
list:addComponent(txUI.UIManager:cloneComponent(btn))
list:addComponent(txUI.Button:new(btn))
...
list:addComponent(txUI.UIManager:cloneComponent(btn))
local exitBtn = txUI.Button:new({text = "exit"; action = (function(self) self.parent.parent:close(); windowb.visible = true; end);})
list:addComponent(txUI.Button:new(exitBtn))
list:addComponent(txUI.UIManager:cloneComponent(exitBtn))
